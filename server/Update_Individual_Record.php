...
switch($method) {
  ...
  case "POST":
    ...
    $interview_informationStmt->bindParam(":id",$updateId); 
    $interview_informationStmt->execute(); 

    // encoding Update
    $encoding_informationUpdate = "UPDATE encoding_information
    ...
    $encoding_informationStmt->bindParam(":id",$updateId);
    $encoding_informationStmt->execute();
    
    //individual_questionpart_a Update
    $individual_question_part_aUpdate = "UPDATE individual_question_part_a
    ...
    $individual_question_part_aStmt->bindParam(":id",$updateId);
    ...
    $individual_question_part_cStmt->bindParam(":id",$updateId);
    $individual_question_part_cStmt->execute();  
    
    // individual_questionpart_d Update
    $individual_question_part_dUpdate = "UPDATE individual_question_part_d
    ...
    $individual_question_part_dStmt->bindParam(":id",$updateId);
