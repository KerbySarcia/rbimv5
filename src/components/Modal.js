          ...
          <div className='IndividualRecord__modal__upload__container'>
            <div className="IndividualRecord__modal__row">
              <div className='IndividualRecord__modal__upload__input'>
                <div className="IndividualRecord__modal__img">{photo ? <img width={200} src={URL.createObjectURL(photo)} alt=""/> : <img src={Photo} alt='Interviewee'/>}</div>
                <label 
              ...
              <div className='IndividualRecord__modal__upload__input'>
                <div className="IndividualRecord__modal__img">{sig ? <img width={200} src={URL.createObjectURL(sig)} alt=""/> : <img src={Signature} alt='Interviewee'/>}</div>
                <label 
                  className='IndividualRecord__modal__upload__label' 
            ...
            <div className="IndividualRecord__modal__row">
              <div className='IndividualRecord__modal__upload__input'>
                <div className="IndividualRecord__modal__img">{thumbL ? <img width={200} src={URL.createObjectURL(thumbL)} alt=""/> : <img src={ThumbL} alt='Interviewee'/>}</div>
                <label 
                  className='IndividualRecord__modal__upload__label' 
              ...
              <div className='IndividualRecord__modal__upload__input'>
                <div className="IndividualRecord__modal__img">{thumbR ? <img width={200} src={URL.createObjectURL(thumbR)} alt=""/> : <img src={ThumbR} alt='Interviewee'/>}</div>
                <label 
                  className='IndividualRecord__modal__upload__label' 
